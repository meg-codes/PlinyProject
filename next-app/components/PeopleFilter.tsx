...
export default class PeopleFilter extends React.Component<PeopleFilterProps, PeopleFilterState> {
    constructor(props: PeopleFilterProps) {
        ...
        if (socialClasses && Array.isArray(socialClasses) && socialClasses.length > 0) {
